...
--
-- Create schema mirangol
--

CREATE DATABASE IF NOT EXISTS mirangol;
USE mirangol;
...
INSERT INTO `projeto` (`id_projeto`,`codigo_projeto`,`nome_projeto`,`descricao_projeto`,`custo_projeto`,`entidade_financiadora`,`id_tipo_projeto`) VALUES 
...
INSERT INTO `tipo_projeto` (`id_tipo_projeto`,`nome_tipo_projeto`) VALUES 
 (1,'Sistema de Gestao Comercial'),
 (2,'Sistema de Gestao Academica');
